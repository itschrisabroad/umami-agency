...
})(["& .contact__tabs{width:100%;padding:0 16px 16px;box-sizing:border-box;}& .contact__tabsTabList{width:100%;display:flex;flex-flow:row nowrap;padding:0;}& .contact__tabsTab{flex:1;list-style:none;display:inline-flex;text-align:center;background:#fff;color:#000;align-items:center;justify-content:center;padding:24px;box-sizing:border-box;transition:0.4s ease all;&:hover{background:#000;color:#fff;}}& .contact__tabsTab.contact__tabsTab--selected{background:#000;color:#fff;}"]);
...
//# sourceMappingURL=6.76ad44e0c8096b53cbf1.hot-update.js.map