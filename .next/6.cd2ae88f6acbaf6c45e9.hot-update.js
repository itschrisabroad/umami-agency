...
})(["width:100%;padding:0 16px 16px;box-sizing:border-box;& .contact__tabsTabList{width:100%;display:flex;flex-flow:row nowrap;padding:0;}& .contact__tabsTab{flex:1;list-style:none;display:inline-flex;text-align:center;background:#000;color:#fff;align-items:center;justify-content:center;padding:24px;box-sizing:border-box;}"]);
...
//# sourceMappingURL=6.cd2ae88f6acbaf6c45e9.hot-update.js.map