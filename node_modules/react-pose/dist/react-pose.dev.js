(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var linear$1$1 = easing.linear,
        easeIn$1 = easing.easeIn,
    ...
    var makePointerEvent = function (_a) {
        ...
        return function (element, activeActions, setPose, config) {
            var eventStartListener = listen(element, startEvents).start(function (startEvent) {
                ...
                var eventEndListener = listen(useDocumentToEnd ? document : element, endEvents).start(function (endEvent) {
    ...
    var createPoseConfig = function (element, _a) {
        var onDragStart = _a.onDragStart,
            ...
            dragBounds = _a.dragBounds,
            config = __rest$1(_a, ["onDragStart", "onDragEnd", "draggable", "onHoverStart", "onHoverEnd", "hoverable", "dragBounds"]);
        var poseConfig = __assign$2({ flip: {} }, config, { props: __assign$2({}, config.props, { draggable: draggable,
        ...
        if (draggable) {
            var _b = dragPoses(draggable),
                ...
                dragEnd = _b.dragEnd;
            poseConfig.dragging = __assign$2({}, poseConfig.dragging, dragging);
    ...
    var index$2 = memoize$1(RegExp.prototype.test.bind(reactPropsRegex));
